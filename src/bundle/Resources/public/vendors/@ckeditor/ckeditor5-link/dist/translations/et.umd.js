...
( e => {
const { [ 'et' ]: { dictionary, getPluralForm } } = {"et":{"dictionary":{"Unlink":"Eemalda link","Link":"Link","Link URL":"Lingi URL","Link URL must not be empty.":"Lingi URL peab olema sisestatud.","Link image":"Lingi pilt","Edit link":"Muuda linki","Open link in new tab":"Ava link uuel vahekaardil","Open in a new tab":"Ava uuel kaardil","Downloadable":"Allalaaditav","Create link":"Loo link","Move out of a link":"Välju lingist","Link properties":"Lingi omadused","Displayed text":"Kuvatud tekst","No links available":"Ühtegi linki pole saadaval"},getPluralForm(n){return (n != 1);}}};
