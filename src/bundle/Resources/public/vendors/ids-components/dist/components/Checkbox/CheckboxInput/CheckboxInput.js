...
var CheckboxInput = exports.CheckboxInput = function CheckboxInput(_ref) {
  ...
  var checkboxClassName = (0, _cssClassNames.createCssClassNames)(_defineProperty({
    'ids-checkbox': true
  }, className, true));
  var inputClassName = (0, _cssClassNames.createCssClassNames)({
...
var CheckboxInputStateful = exports.CheckboxInputStateful = (0, _withStateChecked["default"])(CheckboxInput);