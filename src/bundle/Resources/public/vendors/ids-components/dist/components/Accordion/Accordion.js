...
var Accordion = exports.Accordion = function Accordion(_ref) {
  ...
  var changeExpanded = function changeExpanded(nextIsExpanded) {
    ...
    if (accordionContentRef.current) {
      ...
      accordionContentRef.current.style.height = "".concat(initialHeight, "px");
    ...
    setTimeout(function () {
      if (accordionContentRef.current) {
        ...
        accordionContentRef.current.style.height = "".concat(finalHeight, "px");
      }
    }, FAKE_TIMEOUT_RERENDER);
  };
  var mainClassName = (0, _idsCore.createCssClassNames)({
    'ids-accordion': true,
