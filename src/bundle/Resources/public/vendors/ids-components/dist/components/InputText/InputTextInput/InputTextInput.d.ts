...
export declare const InputTextInput: ({ name, onBlur, onChange, onFocus, onInput, disabled, error, extraAria, className, id, placeholder, processActions, readOnly, ref, required, size, title, type, value, }: InputTextInputProps) => React.JSX.Element;
