...
var _BaseChoiceInput = require("../../../../packages/components/src/partials/BaseChoiceInput");
var _ChoiceInputLabel = require("../../../../packages/components/src/components/ChoiceInputLabel");
...
var ToggleButtonInput = exports.ToggleButtonInput = function ToggleButtonInput(_ref) {
  ...
  var toggleClassName = (0, _cssClassNames.createCssClassNames)(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
    'ids-toggle': true
  ...
  var getLabel = function getLabel() {
    var defaultEnabledLabel = Translator.trans(/*@Desc("Yes")*/'ids.toggle.label.enabled');
    var defaultDisabledLabel = Translator.trans(/*@Desc("No")*/'ids.toggle.label.disabled');
    if (checked) {
...
var ToggleButtonInputStateful = exports.ToggleButtonInputStateful = (0, _withStateChecked["default"])(ToggleButtonInput);