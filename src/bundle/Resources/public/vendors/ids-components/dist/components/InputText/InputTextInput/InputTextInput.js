...
var _BaseInput = require("../../../../packages/components/src/partials/BaseInput");
...
var InputTextInput = exports.InputTextInput = function InputTextInput(_ref) {
  ...
  var inputTextClassName = (0, _cssClassNames.createCssClassNames)(_defineProperty({
    'ids-input-text': true
  }, className, true));
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    extraInputAttrs: _objectSpread({
      ...
      readOnly: readOnly,
      style: {
        paddingRight: "".concat(sourcePadding.toString(), "px")
      }
    }, extraAria),
    id: id,
    name: name,
...
var InputTextInputStateful = exports.InputTextInputStateful = (0, _withStateValue["default"])(InputTextInput);